                            ...
                            <div className="menu d-lg-block d-none">
                                <ul className="m-0 p-0">
                                    <li className="menu-item">
                                        <a className="menu-label" href="/client">DASHBOARD</a>
                                    </li>
                                    <li className="menu-item">
                                        <a className="menu-label" href="/findvendors">VENDORS</a>
                                    </li>
                                    <li className="menu-item">
                                        <a className="menu-label" href="/messages/c">MESSAGES</a>
                                    </li>
                                    ...
                                    <li className="menu-item dropdown" onClick={()=>{this.showSubMenu(this.menuRefs[2])}} ref={this.menuRefs[2]}>
                                        ...
                                        <ul className="sub-menu m-0 bg-white right">
                                            ...
                                            <li className="submenu-item">
                                                <a className="submenu-label" href="/client">
                                            ...
                                            <li className="submenu-item">
                                                <a className="submenu-label" href="/client/settings"><Icon type="setting" className="mr-3"/>Settings</a>
                                            </li>
                                            <li className="submenu-item">
                            ...
                            <div className="menu mobile d-lg-none">
                                ...
                                <div className={`menu-content ${this.props.isOpenMobileMenu ? 'show' : ''}`}>
                                    ...
                                    <ul className="m-0 p-0">
                                        ...
                                        <li><a href="/findvendors">VENDORS</a></li>
                                        <li><a href="/messages/c">MESSAGES</a></li>
                                        <li><a href="/client">HELP & SUPORT</a></li>
                                        ...
                                        <li><a href="/client/settings">SETTING</a></li>
